...
Scanner scanner170 = new Scanner(system.in);
  ...
  public static void runGame{ //Asks player if they'd like to start the game, gets value of answer with scanner170, depending on answer "Y" or "N", boolean variable gameRunning will be set to true or false, and either do nothing or start game
   //ask player Y or N
  ...
  public static void getDifficulty{ // prompts the user to choose difficulty, and the variable difficulty will be set to 1, 2, or 3 depending on the player's choice, which will be stored in difficultyChoice. 
    ...
    while gameRunning == true{ //this will initialize the actual game from the start. If gameRunning is false due to the player losing, it will reset. 
      }
